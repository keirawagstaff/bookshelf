  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <section className="pt-24 pb-16 text-center">
        ...
        <p className="text-gray-500 text-xl max-w-xl mx-auto mb-10" style={{ fontFamily: "system-ui, sans-serif" }}>
          Log what you own, track what you&apos;re reading, and share your shelf with friends who love books too.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-12 py-12">
        <div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed" style={{ fontFamily: "system-ui, sans-serif" }}>
            Catalog every book you own, want, or have read. Search millions of titles via Google Books.
          </p>
        </div>
        <div>
          <div className="text-3xl mb-3">👁</div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed" style={{ fontFamily: "system-ui, sans-serif" }}>
            Move books between &ldquo;Want to read,&rdquo; &ldquo;Reading,&rdquo; and &ldquo;Read.&rdquo; Leave ratings and reviews.
          </p>
        </div>
        <div>
          <div className="text-3xl mb-3">🤝</div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed" style={{ fontFamily: "system-ui, sans-serif" }}>
            Connect with friends and browse their shelves for your next great read.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-b border-gray-200 py-12 text-center">
        ...
        <cite className="text-gray-400 text-sm mt-3 block" style={{ fontFamily: "system-ui, sans-serif" }}>
